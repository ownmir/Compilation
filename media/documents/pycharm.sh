...
elif [ -r "$HOME/.PyCharm2018.1/config/pycharm$BITS.vmoptions" ]; then
  # user-overridden
  VM_OPTIONS_FILE="$HOME/.PyCharm2018.1/config/pycharm$BITS.vmoptions"
...
"$JAVA_BIN" \
  ...
  -Didea.paths.selector=PyCharm2018.1 \
