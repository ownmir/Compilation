...
class PasswordResetTests(TestCase):
    def setUp(self):
        url = reverse('standard-accounts:password_reset')
    ...
    def test_view_function(self):
        view = resolve('/standard-accounts/password_reset/')
...
class SuccessfulPasswordResetTests(TestCase):
    ...
    def test_redirection(self):
        ...
        :return: None
        """
        url = reverse('standard-accounts:password_reset_done')
...
class PasswordResetDoneTests(TestCase):
    ...
    def test_view_function(self):
        view = resolve('/standard-accounts/password_reset/done/')
...
class PasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        url = reverse('standard-accounts:password_reset_confirm', kwargs={'uidb64': self.uid, 'token': self.token})
    ...
    def test_view_function(self):
        view = resolve('/standard-accounts/reset/{uidb64}/{token}/'.format(uidb64=self.uid, token=self.token))
...
class InvalidPasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        url = reverse('standard-accounts:password_reset_confirm', kwargs={'uidb64': uid, 'token': token})
        self.response = self.client.get(url)
    ...
    def test_html(self):
        password_reset_url = reverse('standard-accounts:password_reset')
...
class PasswordResetCompleteTests(TestCase):
    def setUp(self):
        url = reverse('standard-accounts:password_reset_complete')
        self.response = self.client.get(url)
    ...
    def test_view_function(self):
        view = resolve('/standard-accounts/reset/complete/')
